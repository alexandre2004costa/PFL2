...
state(colors, Color1, Color2, BoardSize, BoardStyle):-
...
state(board_size, Color1, Color2, BoardSize, BoardStyle):-
...
state(board_style, Color1, Color2, BoardSize, BoardStyle):-
...
state(exit, Color1, Color2, BoardSize, BoardStyle) :-
    write('Exiting...'), nl, nl. 
